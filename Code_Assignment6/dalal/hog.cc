...
mxArray *process(const mxArray *mximage, const mxArray *mxsbin) {
  ...
  //insert
  //double objW = (double)mxGetScalar(ObjW);
  //double objH = (double)mxGetScalar(ObjH);
  //int objBlockW=(int)round((double)objW /(double)sbin)-2;
  //int objBlockH=(int)round((double)objH /(double)sbin)-2;
  //mxArray *mxfeatvector = mxCreateDoubleMatrix((out[0]-objBlockW+1)*(out[1]-objBlockH+1), 18, mxREAL);
  ////
